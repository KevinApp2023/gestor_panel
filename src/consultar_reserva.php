...
if($_SESSION['priv'] == '1'){
    ...
    $sql = "SELECT r.*, c.nombre, cl.nombres, cl.apellidos FROM reservas r  JOIN canchas c  JOIN clientes cl ON r.id_cancha = c.id AND  r.id_cliente = cl.id  WHERE r.id = '$id' AND r.id_cliente = '$id_cliente'";
  }
