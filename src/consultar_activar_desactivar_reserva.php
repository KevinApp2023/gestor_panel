...
$sql_reservas_activas = "SELECT id, id_cancha FROM reservas WHERE estado IN (1, 3) AND r_fecha = '$fecha' AND '$hora' BETWEEN r_hora_inicio AND r_hora_final";
...
$sql_reservas_finalizadas = "SELECT id, id_cancha FROM reservas  WHERE estado IN (1, 2) AND (r_fecha < '$fecha' OR (r_fecha = '$fecha' AND r_hora_final <= '$hora'))";
